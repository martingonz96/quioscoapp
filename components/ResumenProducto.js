    ...
    return (
        <div className=' shadow p-5 mb-3 flex gap-10 items-center'>
            ...
            <div className=" md:w-4/6">
                ...
                <p className=" text-xl font-bold mt-2 text-amber-500">Precio:{formatearCantidad(producto.precio)}</p>
                <p className=" text-sm font-bold mt-2 text-gray-700">Subtotal:{formatearCantidad(producto.precio * producto.cantidad)}</p>
            </div>
            <div className="">
                <button
                    type="button"
                    className=" bg-sky-700 flex px-5 gap-2 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
